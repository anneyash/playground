...
class QuestionOptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_option" do
    assert_difference('QuestionOption.count') do
      post question_options_url, params: { question_option: { body: @question_option.body, title: @question_option.title } }
    end
  ...
  test "should update question_option" do
    patch question_option_url(@question_option), params: { question_option: { body: @question_option.body, title: @question_option.title } }
